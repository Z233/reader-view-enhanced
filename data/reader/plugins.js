...
chrome.storage.local.get({
  ...
  if (prefs['./plugins/supermemo/core.js']) {
    import('./plugins/supermemo/core.js').then(o => o.enable());
  }
});
chrome.storage.onChanged.addListener(ps => {
  ...
  if ('./plugins/supermemo/core.js' in ps) {
    import('./plugins/supermemo/core.js').then(o => o[ps['./plugins/supermemo/core.js'].newValue ? 'enable' : 'disable']());
  }
});
